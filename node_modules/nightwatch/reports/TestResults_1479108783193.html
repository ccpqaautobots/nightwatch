          ...
          <div class="suite success">
            ...
            <ul class="testcases">
              <li class="testcase success">
                ...
                <div class="name">Element &lt;body&gt; was visible after 1534 milliseconds.</div>
              </li>
              <li class="testcase success">
                <div class="status">&#10003;</div>
                <div class="name">Element &lt;*//p[contains(.,'Logged in as Rachel')]&gt; was visible after 89 milliseconds.</div>
              </li>
            </ul>
          </div>
        </div>
